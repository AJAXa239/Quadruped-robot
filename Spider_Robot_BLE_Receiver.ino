...
/* Size of the robot ---------------------------------------------------------*/
const float length_a = 40;
const float length_b = 60;
const float length_c = 81;
const float length_side = 150;
const float z_absolute = -28;
/* Constants for movement ----------------------------------------------------*/
const float z_default = -60, z_up = -30, z_boot = z_absolute, z_bow_relative = 25, z_tall = -100;
...
{
  if (leg == 0){alpha = 40 - alpha; beta += 10; gamma = 70 - gamma; }
  else if (leg == 1) { alpha = 40 - alpha; beta += 10; gamma += 100; }
  else if (leg == 2) { alpha += 140; beta = 180 - beta; gamma += 90; }
  else if (leg == 3) { alpha += 140; beta = 180 - beta; gamma = 90 - gamma; }
